...
const Registrar = () => {
    ...
    const handleSubmit = async e => {
        ...
        if([nombre, email, password, repetirPassword].includes('')) {
            ...
            return;//Este return bloquea la ejecución del código
        }
        ...
        try {
            ...
            setAlerta({
                msg: error.response.data.msg,// Así comunicó el alerta generado en el BackEnd(veterinarioController.js existeUsuario) con el FrontEnd
                error: true
            })
        }
