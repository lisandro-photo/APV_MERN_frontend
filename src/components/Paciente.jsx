...
const Paciente = ({paciente}) => {
    ...
    const { email, fecha, nombre, propietario, telefono, direccion, sintomas, _id} = paciente;
  ...
  return (
    <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
        ...
        <p className="font-bold uppercase text-indigo-700 my-2">Teléfono de Contacto: {''}
            <span className="font-normal normal-case text-black">{telefono}</span>
        </p>
        <p className="font-bold uppercase text-indigo-700 my-2">Dirección: {''}
